    ...
    <div>
      {/* <SwiperSlider/> */}
       <div className=' custom_gradient w-full h-screen max-md:h-auto max-md:pb-10  flex justify-between max-lg:flex-col max-md:justify-center items-center   px-10 max-lg:mx-2 max-md:gap-8 max-md:mt-20 max-md:px-3 mb-10'>
          ...
          <h1 className='text-5xl text-center text-white  font-semibold mb-4 w-full max-md:text-3xl'>Geologiya fanlar universiteti </h1>
          <h1 className='text-3xl mx-auto font-semibold text-violet-200 max-md:text-xl'>Elektron kutubxonasi </h1>
           
              <div className='grid grid-cols-3 mx-auto max-md:grid max-md:grid-cols-2 gap-10 mt-10'>
              ...
              <a  className='bg-white text-center px-5 py-5 max-md:p-2 max-md:text-md    text-2xl font-semibold tracking-wide max-md:w-36  mt-3 rounded text-violet-600 border-violet-600 hover:text-white border max-md:mt-4   hover:bg-violet-700'  onClick={()=>navigate('https://unilibrary.uz/')}>Unilibrary </a>
