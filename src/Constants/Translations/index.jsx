...
export const translations = {
  en: {
    ...
    {
      id: 1,
      text: "I am strengthening deep and thorough knowledge of Javascript and ReactJs."
    },
    {
      id: 2,
      text: "I work with projects on the Upwork platform.(Freelancer)"
    },
  ],
  ...
  uz: {
    ...
    year2021:"Bu yilda asosiy e'tiborni algoritmlashga qaratildi.C++ orqali ko'plab strukturalarni o'rgandim va dasturlashni mohiyatini tushunib oldim.",
    
    currentlyWorking: [
       {
        id: 2,
        text: "Javascript va ReactJs bo'yicha chuqur va mukammal bilimni mustahkamlamoqdaman."
      },
      {
        id: 1,
        text: "Upwork platformasida loyihalar olib ishlayman.(Freelancer)"
      },
