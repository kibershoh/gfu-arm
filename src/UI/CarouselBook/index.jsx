     ...
     <div id='books' className='books   rounded-md  px-10 max-md:px-3'>
        ...
        <form className='w-1/2 max-md:w-full'>
          ...
          <div className="relative">
            ...
            type="search" id="default-search" className="block outline-none w-full p-4  ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue  -500 focus:border-blue  -500 " placeholder={t('search')} required />
