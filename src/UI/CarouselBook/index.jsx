     ...
     <div id='books' className='books   rounded-md  px-10 max-md:px-3'>
        ...
        <form className='w-1/2 max-md:w-full'>
          ...
          <div className="relative">
            ...
            type="search" id="default-search" className="block outline-none w-full p-4  ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue  -500 focus:border-blue  -500 " placeholder="Search Mockups, Logos..." required />
        ...
        <div id="booksId" className="my-10 2xl:w-7/12 2xl:mx-auto flex justify-between gap-10 max-md:gap-2 mx-20 max-lg:mx-5 max-lg:my-4">
          ...
          <select 
            id="large" 
            className="block px-4 outline-none py-3 max-md:py-1 max-md:px-2 text-base text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue  -500 focus:border-blue  -500"
